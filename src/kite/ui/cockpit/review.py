"""Changes and verification review surfaces."""

from __future__ import annotations

from rich.text import Text

from kite.ui.cockpit.view_model import ReviewState, VerificationCheck
...
def render_changes_panel(review: ReviewState, *, max_files: int = 8) -> Text:
    ...
    for item in review.files[:max_files]:
        ...
        block.append(item.path[-40:], style="kite.tool" if review.selected_path == item.path else "")
        block.append("  ", style="")
