...
THEME_HELP = {
    ...
    "ocean": "deep blue — cyan brand, aqua accents",
    "sunset": "warm orange — coral brand, gold accents",
    "midnight": "very dark — purple brand, violet accents",
}
...
_PALETTES: dict[str, dict[str, Any]] = {
    ...
    "ocean": _entry(
        styles=_styles(
            **{
                "kite.brand": "bold #00d4ff",
                "kite.thinking": "italic #5a7a8a",
                "kite.reasoning": "italic #5a7a8a",
                "kite.muted": "#5a7a8a",
                "kite.terminal": "#6a8a9a",
                "kite.tool": "#00bfff",
                "kite.success": "bold #00ff88",
                "kite.pending": "bold #00d4ff",
                "kite.error": "bold #ff5a5a",
                "kite.diff.add": "bold #00ff88",
                "kite.diff.del": "bold #ff5a5a",
                "kite.diff.hunk": "bold #00d4ff",
                "kite.diff.meta": "#3a5a6a",
                "kite.diff.ctx": "#5a7a8a",
                "kite.plan": "bold #00d4ff",
                "kite.build": "bold #00ff88",
                "kite.accent": "bold #00ffff",
                "kite.highlight": "bold #00ffff",
                "kite.task": "bold #00ffff",
                "kite.task.done": "#00ff88",
                "kite.task.active": "bold #00d4ff",
                "kite.task.pending": "#4a9aaa",
                "kite.task.bar": "#00ff88",
                "kite.task.bar_empty": "#0a1a2a",
                "kite.pick": "#00d4ff",
                "kite.pick.current": "bold #00ff88",
            }
        ),
        dark=True,
        syntax="ansi_dark",
        ...
        ui=_dark_ui(
            ...
            toolbar_bg="#0a1a2a",
            toolbar_fg="#8abaca",
            completion_bg="#0a1a2a",
            completion_fg="#d0f0ff",
            completion_current_bg="#0a1a2a",
            completion_current_fg="#00ffff",
            completion_meta="#5a7a8a",
            completion_meta_current="#00d4ff",
            scrollbar_bg="#102030",
            scrollbar_btn="#1a3a4a",
            autosuggest="#2a4a5a",
            prompt="#00d4ff bold",
        ),
    ),
    "sunset": _entry(
        styles=_styles(
            **{
                "kite.brand": "bold #ff6b6b",
                "kite.thinking": "italic #8a6a5a",
                "kite.reasoning": "italic #8a6a5a",
                "kite.muted": "#8a6a5a",
                "kite.terminal": "#9a7a6a",
                "kite.tool": "#ffa366",
                "kite.success": "bold #7cb342",
                "kite.pending": "bold #ffd54f",
                "kite.error": "bold #ff5252",
                "kite.diff.add": "bold #7cb342",
                "kite.diff.del": "bold #ff5252",
                "kite.diff.hunk": "bold #ff6b6b",
                "kite.diff.meta": "#6a5a4a",
                "kite.diff.ctx": "#8a7a6a",
                "kite.plan": "bold #ffd54f",
                "kite.build": "bold #7cb342",
                "kite.accent": "bold #ff9800",
                "kite.highlight": "bold #ffa366",
                "kite.task": "bold #ff9800",
                "kite.task.done": "#7cb342",
                "kite.task.active": "bold #ff6b6b",
                "kite.task.pending": "#b07a4a",
                "kite.task.bar": "#7cb342",
                "kite.task.bar_empty": "#2a1a0a",
                "kite.pick": "#ff6b6b",
                "kite.pick.current": "bold #7cb342",
            }
        ),
        dark=True,
        syntax="ansi_dark",
        ...
        ui=_dark_ui(
            ...
            toolbar_bg="#1a1008",
            toolbar_fg="#c8a898",
            completion_bg="#1a1008",
            completion_fg="#f0e0d0",
            completion_current_bg="#1a1008",
            completion_current_fg="#ffa366",
            completion_meta="#8a6a5a",
            completion_meta_current="#ff6b6b",
            scrollbar_bg="#2a1810",
            scrollbar_btn="#3a2818",
            autosuggest="#4a3a2a",
            prompt="#ff6b6b bold",
    ...
    "midnight": _entry(
        styles=_styles(
            **{
                "kite.brand": "bold #a78bfa",
                "kite.thinking": "italic #4a4a6a",
                "kite.reasoning": "italic #4a4a6a",
                "kite.muted": "#4a4a6a",
                "kite.terminal": "#5a5a7a",
                "kite.tool": "#8b5cf6",
                "kite.success": "bold #6ee7b7",
                "kite.pending": "bold #a78bfa",
                "kite.error": "bold #f87171",
                "kite.diff.add": "bold #6ee7b7",
                "kite.diff.del": "bold #f87171",
                "kite.diff.hunk": "bold #a78bfa",
                "kite.diff.meta": "#3a3a5a",
                "kite.diff.ctx": "#4a4a6a",
                "kite.plan": "bold #a78bfa",
                "kite.build": "bold #6ee7b7",
                "kite.accent": "bold #c084fc",
                "kite.highlight": "bold #8b5cf6",
                "kite.task": "bold #c084fc",
                "kite.task.done": "#6ee7b7",
                "kite.task.active": "bold #a78bfa",
                "kite.task.pending": "#5a5a8a",
                "kite.task.bar": "#6ee7b7",
                "kite.task.bar_empty": "#0a0a1a",
                "kite.pick": "#a78bfa",
                "kite.pick.current": "bold #6ee7b7",
            }
        ),
        dark=True,
        syntax="ansi_dark",
        ...
        ui=_dark_ui(
            ...
            toolbar_bg="#080818",
            toolbar_fg="#7a7a9a",
            completion_bg="#080818",
            completion_fg="#b0b0d0",
            completion_current_bg="#080818",
            completion_current_fg="#a78bfa",
            completion_meta="#4a4a6a",
            completion_meta_current="#8b5cf6",
            scrollbar_bg="#101028",
            scrollbar_btn="#181838",
            autosuggest="#2a2a4a",
            prompt="#a78bfa bold",
        ),
    ),
