...
BUILTINS: tuple[BuiltinCommand, ...] = (
    ...
    BuiltinCommand(
        "cockpit",
        "Toggle run-centric cockpit layout (Ctrl+Space when terminal is large enough)",
        hint="[on|off|refresh]",
        group="session",
    ),
    BuiltinCommand(
    ...
    BuiltinCommand("help", "Command map, shortcuts, guide.md, and remaining docs", aliases=("h",), group="session"),
