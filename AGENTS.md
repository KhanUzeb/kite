...
**Kite** v1.0.2 — Python 3.11+ package (`src/kite/`). Slim hybrid harness:
...
```bash
./scripts/bump_release.sh 0.9.8   # bump, sync README/AGENTS/docs, CHANGELOG stub, tag
# edit CHANGELOG.md + docs/RELEASE-0.9.8.md
